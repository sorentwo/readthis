...
RSpec.describe Readthis::Compressor do
  describe '#compress' do
    it 'compresses the input' do
      compressor   = Readthis::Compressor.new(minimum: 0)
      input      = 'aaa bbb ccc'
    ...
    it 'passes input below the minimum size through uncompressed' do
      compressor = Readthis::Compressor.new(minimum: 1024)
      input      = 'abcdefg'
